// CRUD Users - Tela principal/usuarios.html + Modals
// Copy modal functions from usuario.js
      ...
      <tr class="hover:bg-white/5 transition-all duration-200 group">
        <td class="py-3 px-6">
          <div class="flex items-center gap-3">
            <img src="https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=1E3A5F&color=fff" alt="Avatar" class="w-8 h-8 rounded-full border border-white/10">
  ...
  if (editForm) {
    editForm.addEventListener('submit', (e) => {
      ...
      const formData = {
        ...
        senha: editForm.querySelector('input[type="password"]').value || undefined
      };
...
// ... similar for updateUser, deleteUser
